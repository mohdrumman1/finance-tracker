...
function LoginForm() {
  ...
  const [error, setError] = useState(googleError ? (GOOGLE_ERRORS[googleError] ?? 'Sign-in failed.') : '')
    ...
    <div className="min-h-screen w-full bg-gray-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          ...
          <p className="text-gray-400 text-sm mb-6">Sign in to access your financial dashboard</p>
